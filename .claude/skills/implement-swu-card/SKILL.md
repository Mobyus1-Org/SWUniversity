...
**Batch max: 20 cards per session.** If given more, implement the first 20 and tell the user to start a new session for the rest.
...
- Given more than 20 cards → implement the first 20 only, tell user to continue in a new session
