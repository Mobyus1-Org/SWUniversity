...
function QuizPage() {
  ...
  return <div>
    <h1 className="w-auto mx-auto text-center text-4xl font-bold mt-1 md:text-4xl uwd:!text-5xl 4k:!text-7xl font-bold mb-4 uwd:ml-2 4k:ml-4">{getModeTitle("quiz", quizMode)}</h1>
    {
