...
function DoYouKnowSWUPage() {
  ...
  const renderQuestionContent = () => currentQuestionSet.length === 0
    ...
    return <div>
      <h1 className="w-auto mx-auto text-center text-4xl font-bold mt-2 md:text-4xl uwd:!text-5xl 4k:!text-7xl font-bold mb-4 uwd:ml-2 4k:ml-4">{getModeTitle("do you know swu?", dykswuMode)}</h1>
      {
