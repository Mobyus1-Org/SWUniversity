  ...
  return <div className="grid md:grid-cols-3 gap-4 md:gap-8">
    ...
    <div className={`p-4 border md:col-span-3 ${globalBackgroundStyle}`}>
      ...
      <ul className="list-disc list-inside text-lg uwd:text-2xl 4k:text-4xl">
        ...
        <li className="mb-1"><a href="https://forcetable.com" className="text-blue-500 underline">Force Table</a> - A website for STAR WARS: Unlimited players to play against a simulated opponent. Great for practicing a new deck.</li>
