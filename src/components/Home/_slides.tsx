...
export const slides: ICarouselData[] = [
  ...
  },
  {
    ...
    description: "A video where Mobyus1 tests FFG SWU creators' knowledge of the cards they made! Think this looks fun? You can try try it yourself by playing the \"DYKSWU?\" mode here on this site!",
  },
];
